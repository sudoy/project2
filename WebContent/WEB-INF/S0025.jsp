...
<form class="form-horizontal" method="POST" action="S0021_売上検索結果一覧画面">
	<table>
	...
	<tr><th>商品名</th>
	<td><div class="col-md-8">
	<input class="form-control" type="text" placeholder="商品" value="からあげ弁当" disabled>
	</div></td></tr>
	<tr><th>単価</th>
	<td><div class="col-md-3">
	<input class="form-control" id="right" type="text" placeholder="単価" value="450" disabled>
	</div></td></tr>
	<tr><th>個数</th>
	<td><div class="col-md-3">
	<input class="form-control" id="right" type="text" placeholder="個数" value="3" disabled>
	</div></td></tr>
	<tr><th>小計</th>
	<td><div class="col-md-3">
	<p disabled>1,620</p>
	...
	<td><div class="col-md-8">
	<textarea class="form-control" id="detail" rows="3" placeholder="備考" disabled>今日からの新商品</textarea>
	</div></td>
	</tr>
	...
	<div class="form-group">
		...
		<a type="button" class="btn btn-default" id="cancel" href="S0022_売上詳細表示画面.html">キャンセル</a>
	</div>
	</td></tr>
	</table>
</form>
